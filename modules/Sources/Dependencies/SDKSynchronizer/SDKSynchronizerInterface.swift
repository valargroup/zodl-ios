...
public struct SDKSynchronizerClient {
    ...
    public var broadcasterCreateProposedTransactions: (Proposal, UnifiedSpendingKey) async throws -> [ZcashTransaction.Overview]
    public var createAndSubmitProposedTransactions: (Proposal, UnifiedSpendingKey) async throws -> CreateProposedTransactionsResult
    public var proposeShielding: (AccountUUID, Zatoshi, Memo, TransparentAddress?) async throws -> Proposal?

    // Multi-server submission
    public var broadcasterSubmit: (Data, LightWalletEndpoint) async throws -> Void
    ...
    public var broadcasterCreateTransactionFromPCZT: (Pczt, Pczt) async throws -> [ZcashTransaction.Overview]
    public var createAndSubmitTransactionFromPCZT: (Pczt, Pczt) async throws -> CreateProposedTransactionsResult
