...
extension SDKSynchronizerClient: TestDependencyKey {
    public static let testValue = Self(
        ...
        createProposedTransactionsWithoutSubmitting: unimplemented("\(Self.self).createProposedTransactionsWithoutSubmitting", placeholder: []),
        ...
        getPIRActivityEntries: unimplemented("\(Self.self).getPIRActivityEntries", placeholder: []),
...
extension SDKSynchronizerClient {
    public static let noOp = Self(
        ...
        createProposedTransactionsWithoutSubmitting: { _, _ in [] },
        proposeShielding: { _, _, _, _ in nil },
        submitTransaction: { _, _ in },
...
extension SDKSynchronizerClient {
    public static func mocked(
        ...
        createProposedTransactionsWithoutSubmitting:
        ...
        submitTransaction: @escaping (Data, LightWalletEndpoint) async throws -> Void = { _, _ in },
        ...
        getPIRActivityEntries: @escaping () async throws -> [PIRActivityEntry] = { [] },
        ...
        SDKSynchronizerClient(
            ...
            createProposedTransactionsWithoutSubmitting: createProposedTransactionsWithoutSubmitting,
            ...
            getPIRActivityEntries: getPIRActivityEntries,
