...
extension SDKSynchronizerClient: TestDependencyKey {
    public static let testValue = Self(
        ...
        broadcasterCreateProposedTransactions: unimplemented("\(Self.self).broadcasterCreateProposedTransactions", placeholder: []),
        ...
        broadcasterSubmit: unimplemented("\(Self.self).broadcasterSubmit"),
        ...
        broadcasterCreateTransactionFromPCZT: unimplemented("\(Self.self).broadcasterCreateTransactionFromPCZT", placeholder: []),
...
extension SDKSynchronizerClient {
    public static let noOp = Self(
        ...
        broadcasterCreateTransactionFromPCZT: { _, _ in [] },
...
extension SDKSynchronizerClient {
    public static func mocked(
        ...
        broadcasterCreateProposedTransactions:
        @escaping (Proposal, UnifiedSpendingKey) async throws -> [ZcashTransaction.Overview] = { _, _ in [] },
        ...
        broadcasterSubmit: @escaping (Data, LightWalletEndpoint) async throws -> Void = { _, _ in },
        ...
        broadcasterCreateTransactionFromPCZT: @escaping (Pczt, Pczt) async throws -> [ZcashTransaction.Overview] = { _, _ in [] },
        createAndSubmitTransactionFromPCZT: @escaping (Pczt, Pczt) async throws -> CreateProposedTransactionsResult = { _, _ in .success(txIds: []) },
        ...
        SDKSynchronizerClient(
            ...
            broadcasterCreateProposedTransactions: broadcasterCreateProposedTransactions,
            createAndSubmitProposedTransactions: createAndSubmitProposedTransactions,
            proposeShielding: proposeShielding,
            broadcasterSubmit: broadcasterSubmit,
            ...
            broadcasterCreateTransactionFromPCZT: broadcasterCreateTransactionFromPCZT,
